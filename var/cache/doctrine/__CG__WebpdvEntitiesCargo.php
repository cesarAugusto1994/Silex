 ...
 */
class Cargo extends \Webpdv\Entities\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Webpdv\\Entities\\Cargo' . "\0" . 'id', '' . "\0" . 'Webpdv\\Entities\\Cargo' . "\0" . 'nome', '' . "\0" . 'Webpdv\\Entities\\Cargo' . "\0" . 'ativo'];
        }
